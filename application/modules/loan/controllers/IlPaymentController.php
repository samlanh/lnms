...
class Loan_IlPaymentController extends Zend_Controller_Action {
	...
	public function indexAction(){
		...
		if($this->getRequest()->isPost()){
			...
			$collumns = array("BRANCH_NAME","RECIEPT_NO","LOAN_NO","CLIENT","TOTAL_PRINCEPLE","TOTAL_INTEREST","PENALIZE AMOUNT","TOTAL_PAYMENT","RECEIVE_AMOUNT","PAYMENT_DATE","DATE","CO_NAME",
				);
			$link=array(
  ...
  function addAction()
  {
	...
	function editAction()
	{
		...
		if($current_date<$last_pay_date){
			Application_Form_FrmMessage::Sucessfull("WARNNING_EDIT_LOAN","/loan/ilpayment/");
		}
